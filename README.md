...
Emphasizing usability, clarity, and responsiveness, CafeHub reimagines traditional service workflows through a modern, user-centered design approach.

# 📊Data Approach

Built as an ASP.NET Core Web Application, the system uses in-memory (hardcoded) data due to the academic scope of the project.
The main focus was placed on UI/UX design and user interaction flow rather than persistent data storage.
